...
def vgg3(IMG_DIM, num_classes, opt, dpt, ki):
    model = Sequential()
...
def vgg4(IMG_DIM, num_classes, opt, dpt, ki):
    model = Sequential()
    model.add(Conv2D(32, (3, 3), activation='relu', kernel_initializer=ki, padding='same', input_shape=(IMG_DIM, IMG_DIM, 3)))
    model.add(Conv2D(32, (3, 3), activation='relu', kernel_initializer=ki, padding='same'))
    model.add(MaxPool2D((2, 2)))
...
def vgg5(IMG_DIM, num_classes, opt, dpt, ki):
    model = Sequential()
    model.add(Conv2D(32, (3, 3), activation='relu', kernel_initializer=ki, padding='same', input_shape=(IMG_DIM, IMG_DIM, 3)))
    model.add(Conv2D(32, (3, 3), activation='relu', kernel_initializer=ki, padding='same'))
    model.add(MaxPool2D((2, 2)))
...
def vgg6(IMG_DIM, num_classes, opt, dpt, ki):
    model = Sequential()
    model.add(Conv2D(32, (3, 3), activation='relu', kernel_initializer=ki, padding='same', input_shape=(IMG_DIM, IMG_DIM, 3)))
    model.add(Conv2D(32, (3, 3), activation='relu', kernel_initializer=ki, padding='same'))
    model.add(MaxPool2D((2, 2)))
